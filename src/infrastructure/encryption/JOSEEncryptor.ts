...
function decodePemPublicKey(publicKeyB64Encoded: string): forgePki.rsa.PublicKey {
    ...
    return forgePki.publicKeyFromAsn1(publicKeyObject2);
}
...
export class JOSEEncryptor {
    static encrypt<PlainTextValues>(plainTextValues: PlainTextValues, publicKeyResponse: PublicKeyResponse): string {
